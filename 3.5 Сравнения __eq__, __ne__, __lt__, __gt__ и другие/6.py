...
class MoneyR:
    ...
    def __eq__(self, other):
        if self.cb == None or other.cb == None:
            raise ValueError("Неизвестен курс валют.")

        if type(other) == MoneyD:
            return round(self.cb.rates['rub'],1) == round(other.cb.rates['rub'] * other.volume,1)
        elif type(other) == MoneyE:
            return round(self.cb.rates['rub'],1) == round(other.cb.rates['rub'] * (other.cb.rates['euro'] * other.volume),1)
        else:
            return round(self.volume,1) == round(other.volume,1)
...
class MoneyD:
    ...
    def __eq__(self, other):
        ...
        if type(other) == MoneyR:
            return round(self.volume * self.cb.rates['rub'],1) == round(other.volume,1)
        elif type(other) == MoneyE:
            return round(self.volume * self.cb.rates['rub'],1) == round(other.cb.rates['rub'] * (other.cb.rates['euro'] * other.volume),1)
        else:
            return round(self.volume * self.cb.rates['rub'],1) == round(other.cb.rates['rub'] * other.volume,1)
...
class MoneyE:
    ...
    def __eq__(self, other):
        ...
        if type(other) == MoneyR:
            return round(self.cb.rates['rub'] * (self.cb.rates['euro'] * self.volume),1) == round(other.volume,1)
        elif type(other) == MoneyD:
            return round(self.cb.rates['rub'] * (self.cb.rates['euro'] * self.volume),1) == round(other.cb.rates['rub'] * other.volume,1)
        else:
            return round(self.cb.rates['rub'] * (self.cb.rates['euro'] * self.volume),1) == round(self.cb.rates['rub'] * (self.cb.rates['euro'] * self.volume),1)
